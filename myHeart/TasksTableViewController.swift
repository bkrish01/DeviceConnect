...
class TasksTableViewController: UITableViewController, ORKTaskViewControllerDelegate {
    ...
    let sections = ["Clinical Trial Survey Questionnaire", "Clinical Trial Activity Tasks"]
    let surveys = [["Migraine - Phase 1","Migraine - Phase 2"], ["Sleep Activity","Step"]]
    var tasks = [[SurveyTask,SurveyTask], [TwoFingerTappingTask, TwoFingerTappingTask]]
